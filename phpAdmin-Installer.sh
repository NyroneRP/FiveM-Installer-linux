...
while getopts ":sh" option; do
  case $option in
    h )
      ...
      echo
      echo "Syntax: bash <(curl -s https://raw.githubusercontent.com/NyroneRP/FiveM-Installer-linux/main/BashSelection.sh) [-h|-s]"
      echo
      echo "options:"
...
source <(curl -s https://raw.githubusercontent.com/NyroneRP/FiveM-Installer-linux/main/BashSelector.sh)
